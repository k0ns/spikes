...
for i = 1:1
    ...
    savedData(i).features = [feature1 feature2 feature3 feature4 feature5 feature6 feature7]; 
end
...
plot(round((thirdZeroVect(g)+secondZeroVect(g))/2),savedData(i).spikeEst(round((thirdZeroVect(g)+secondZeroVect(g))/2),g),'m*')
...
legend('Kumatomorfes','firstZero','secondZero','ThirdZero','Endiamesa se 2,3 Zeros')
%}